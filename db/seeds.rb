...
Themastercare.create!(name: 'Pre School', description: '1st Term Tuition', price: 25000, image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/mastercarephotos/mastercare4.png',  category_id: primaryschool.id)
Themastercare.create!(name: 'Reception', description: '1st Term Tuition', price: 250000, image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/mastercarephotos/mastercare2.png',  category_id: primaryschool.id)
Themastercare.create!(name: 'Kindergarden', description: '1st Term Tuition', price: 250000, image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/mastercarephotos/mastercare5.png',  category_id: primaryschool.id)
Themastercare.create!(name: 'Nursery', description: '1st Term Tuition', price: 300000, image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/mastercarephotos/mastercare7.png',  category_id: primaryschool.id)
Themastercare.create!(name: 'Primary 1-3', description: '1st Term Tuition', price: 350000, image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/mastercarephotos/top',  category_id: primaryschool.id)
Themastercare.create!(name: 'Primary 4-6', description: '1st Term Tuition', price: 350000, image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/mastercarephotos/top',  category_id: primaryschool.id)
