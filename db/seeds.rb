...
Marketplace.create!(name: 'Business Name Registration', price: 300000, description: 'Business Name Registation', image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/ip_incorporation/businessname_registration.png',  vendor: 'mbiafrica', category_id: propertyforsale.id)
...
Marketplace.create!(name: 'Web Application Training', price: 12000, description: 'Web Application Development Training', image_url: 'https://s3.us-east-2.amazonaws.com/babanla/assets/hdt5.png',  vendor: 'Hard Skills Hub', category_id: hardskillshub.id)
